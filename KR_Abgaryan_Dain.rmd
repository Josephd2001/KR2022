---
title: "Курсовая работа - Динамика цен на рынке жилья в субъектах РФ"
author: "Абгарян Арен (БЭК-194), Даин Джозеф (БЭК-192)"
date: '2022-06-06'
...
Загрузка данных, первичный рынок
...
Загрузка данных, вторичный рынок
...
Подготовка данных по первичному рынку к анализу, логарифмирование переменных
...
Построение моделей ARIMA, первичный рынок
...
#Подсчет прогнозного годового темпа роста
...
Построение модели панельного VAR, первичный рынок
...
panel_1_vse <-pvargmm(
  dependent_vars = vec_ex,
  lags = 1,
  transformation = "fd",
  data = vse_1,
  panel_identifier = c("region","period"),
  steps = c("twostep"),
...
Подсчет RMSFE и проведение теста Диболда-Мариано
...
Построение модели ARIMA, вторичный рынок
...
Модель панельного VAR, вторичный рынок
...
Подсчёт RMSFE, тест Диболда-Мариано
...
Выгрузка графиков прогнозов по трём регионам по всем моделям

```{r}
#Moscow_for_panel_1_plot <- read_excel("Moscow_for_panel (1).xlsx")
#SVRDL_for_panel_1_plot <- read_excel("SVRDL_for_panel (1).xlsx")
#SPB_for_panel_1_plot <- read_excel("SPB_for_panel (1).xlsx")
#vSel_t = grep("_1", Moscow_for_panel_1_plot$Период)
